...
function loaddata() {
	...
	for(i = 0; i < 50; i++){
		var track_url = array["tracks"][i]["track_url"]
		var track_id = track_url.split("https://play.spotify.com/track/")
	...
	request = $.getJSON('https://api.spotify.com/v1/tracks/?ids='+songarray, function(data){
		...
		while (fake_number2 == fake_number1 || fake_number2 == i) {
			fake_number2 = getRandomInt(0,49);
		}
		fake_number.push(fake_number2)
		var fake_number3 = getRandomInt(0,49)
		while (fake_number3 == fake_number2 || fake_number3 == fake_number1 || fake_number1 == i) {
